// @/pages/humanReviewQueue/HumanReviewFiltersSection.tsx
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
import { Search } from 'lucide-react';
import { ReviewStatusEnum, PriorityEnum, ReviewStatusLabels, PriorityLabels } from '@/constants/common';
import { ReviewerOption } from '@/types/notes';
import { getEnumValues } from '@/utils/helper';

interface HumanReviewFiltersSectionProps {
  filters: {
    status: string;
    priority: string;
    reviewer: string;
...
export const HumanReviewFiltersSection = ({
  filters,
  reviewers,
  loading,
  onFilterChange,
  onApplyFilters,
  onClearFilters,
}: HumanReviewFiltersSectionProps) => {
  return (
